...
final class Version20231020050646 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE city (id INT AUTO_INCREMENT NOT NULL, province_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, postal_code VARCHAR(255) NOT NULL, INDEX IDX_2D5B0234D72A0A7A (province_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE student (id INT AUTO_INCREMENT NOT NULL, tariff_id INT DEFAULT NULL, bank_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, email VARCHAR(255) DEFAULT NULL, address VARCHAR(255) DEFAULT NULL, payment INT NOT NULL, schedule VARCHAR(255) DEFAULT NULL, comments LONGTEXT DEFAULT NULL, surname VARCHAR(255) NOT NULL, birth_date DATE NOT NULL, city_id INT DEFAULT NULL, parent_id INT DEFAULT NULL, dni VARCHAR(255) DEFAULT NULL, phone VARCHAR(255) DEFAULT NULL, has_image_rights_accepted TINYINT(1) DEFAULT NULL, has_sepa_agreement_accepted TINYINT(1) DEFAULT NULL, INDEX IDX_B723AF3392348FD2 (tariff_id), INDEX IDX_B723AF3375EE5022 (bank_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE city ADD CONSTRAINT FK_2D5B0234D72A0A7A FOREIGN KEY (province_id) REFERENCES province (id)');
        ...
        $this->addSql('ALTER TABLE student ADD CONSTRAINT FK_B723AF3375EE5022 FOREIGN KEY (bank_id) REFERENCES bank (id)');
    }
